...
const Home = () => {
  return (
    <div class="intro">
      ...
      <p>So, I've organized everything and posted it here. Toys can be view through the navigation above. You either access all the toys in 'All Toys' and filter through them or they can be viewed in 'Toys by Company', which organizes all the toys by company and they can still be filtered through.</p>
