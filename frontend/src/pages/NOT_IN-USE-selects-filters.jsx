  ...
  return (
    ...
    <>
      ...
      <select
        ...
        onChange={(e) =>
          setSelectedFilters({ ...selectedFilters, series: e.target.value })
        }
      >
      ...
      <select
        ...
        onChange={(e) =>
          setSelectedFilters({ ...selectedFilters, collections: e.target.value })
        }
      >
      ...
      <select
        value={selectedFilters.completed}
        onChange={(e) =>
          setSelectedFilters({ ...selectedFilters, completed: e.target.value })
        }
      >
        <option value="">Completed</option>
        {filterOptions.completed.map((completed) => (
...
<div className="filter-section">
  <div className="row">
    ...
    <div className="col-2">
    <Form.Select aria-label="Brands" value={selectedFilters.brand}
    ...
    <div className="col-2">
    <Form.Select aria-label="Series" value={selectedFilters.series}
          onChange={(e) => {
    ...
    <div className="col-2">
    <Form.Select aria-label="Brands" value={selectedFilters.collection}
          onChange={(e) => {
    ...
    <Form.Select aria-label="Default select example">
      ...
      <option value="3">Three</option>
        ...
        <select
          value={selectedFilters.completed}
          onChange={(e) => setSelectedFilters({ ...selectedFilters, completed: e.target.value })}
        >
      ...
      <ScrollableContent currentToys={filteredToys} />
